...
class EncoderLSTM:
    def __init__(self, graph_train, graph_test, pattern_train, pattern_test, y_train, y_test,
        ...
        graph_train = tf.keras.layers.Dense(100, activation=tf.nn.relu)(
            input1)

        pattern_merge = tf.keras.layers.Reshape((1, 750))(input2)

        pattern_train = tf.keras.layers.Dense(100, activation=tf.nn.relu)(
            pattern_merge)
