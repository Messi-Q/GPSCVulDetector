...
def get_pattern_feature():
    ...
    # pattern_feature_train_data_path = "./pattern_feature/feature_by_zeropadding/reentrancy_pattern_train.txt"
    ...
    # pattern_feature_test_data_path = "../pattern_feature/feature_by_zeropadding/pattern_valid.txt"
...
def get_graph_feature():
    ...
    graph_feature_train_label_path = "./graph_feature/reentrancy/label_by_experts_train.txt"  # 暂时不用

    graph_feature_test_data_path = "./graph_feature/reentrancy/reentrancy_final_valid.txt"
    graph_feature_test_label_path = "./graph_feature/reentrancy/label_by_experts_valid.txt"  # 暂时不用
